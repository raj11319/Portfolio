                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:contact@rajsrivastava.com" className="text-primary-600 dark:text-primary-400 hover:underline">
                        contact@rajsrivastava.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="tel:+1234567890" className="text-secondary-600 dark:text-secondary-400 hover:underline">
                        +1 (234) 567-890
                      </a>
                    </div>
                  </div>
